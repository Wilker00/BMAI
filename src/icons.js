const icons = {
  ...
  star: '<path d="M12 3.5l2.7 5.5 6.1.9-4.4 4.3 1 6-5.4-2.9-5.4 2.9 1-6-4.4-4.3 6.1-.9z"/>',
  schedule: '<circle cx="12" cy="12" r="8"/><path d="M12 8v4l2.8 1.8"/>',
  flash_on: '<path d="M13 2L5 14h6l-1 8 9-13h-6z" fill="currentColor" stroke="none"/>'
};
